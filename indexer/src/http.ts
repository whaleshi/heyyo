...
export function createApiServer(options: { configured: boolean; rewards?: (address: string) => Promise<unknown>; claims?: (address: string) => Promise<unknown>; list: (query: TokenListQuery) => Promise<TokenList | null> }) {
